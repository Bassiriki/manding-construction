      ...
      <div className="container mx-auto px-4">
        <div className="flex h-20 items-center justify-between relative">
          ...
          <a href="#accueil" className="flex items-center gap-3 group">
            ...
            <p className="text-lg font-bold text-green-700 group-hover:text-green-500 transition-colors duration-300">
            ...
            <div ref={searchRef} className="relative">
              ...
              {isSearchOpen && (
                ...
                >
                  ...
                  />
                  <Button size="sm" className="bg-green-700 hover:bg-green-600 text-white px-3 py-1 text-xs">
                    OK
                  </Button>
                </form>
              )}
        ...
        {/* ---- NAV SECONDAIRE ---- */}
        <div className="hidden lg:flex items-center justify-center gap-8 py-3 border-t border-gray-200">
